...
public class PullToRecycleView extends PullToRefreshBase<RecyclerView> {
    ...
    public PullToRecycleView(Context context, Mode mode, AnimationStyle style) {
    ...
    final class InternalScrollViewSDK9 extends RecyclerView {
        ...
        protected boolean overScrollBy(int deltaX, int deltaY, int scrollX, int scrollY, int scrollRangeX,
            ...
            OverscrollHelper.overScrollBy(PullToRecycleView.this, deltaX, scrollX, deltaY, scrollY,
